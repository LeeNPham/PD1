<script>
	export let Class = 'h-3 w-auto fill-white';
</script>

<div class="bg-type-normal h-5 w-5 rounded-full flex items-center justify-center">
	<svg class={Class} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
		<path
			fill-rule="evenodd"
			clip-rule="evenodd"
